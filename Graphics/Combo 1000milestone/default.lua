...
return Def.ActorFrame{
	...
	LoadActor(THEME:GetPathG("", "_VisualStyles/"..style.."/Combo 1000milestone swoosh"))..{
		...
		ThousandMilestoneCommand=function(self)
			self:finishtweening():diffuse(c):zoom(0.25):diffusealpha(0.7):x(0):linear(0.7):zoom(3):diffusealpha(0):x(100)
		end;
	},
	...
	LoadActor(THEME:GetPathG("", "_VisualStyles/"..style.."/Combo 1000milestone swoosh"))..{
		...
		ThousandMilestoneCommand=function(self)
			self:finishtweening():diffuse(c):rotationy(180):zoom(0.25):diffusealpha(0.7):x(0):linear(0.7):zoom(3):diffusealpha(0):x(-100)
		end;
	}
}