...
return Def.ActorFrame{
	...
	LoadActor("explosion.png")..{
		InitCommand=function(self) self:diffusealpha(0):blend('add') end;
	...
	LoadActor(THEME:GetPathG("", "_VisualStyles/"..style.."/Combo 100milestone splode"))..{
		InitCommand=function(self) self:diffusealpha(0):blend('add') end;
		HundredMilestoneCommand=function(self)
			self:finishtweening():diffuse(c):rotationz(10):zoom(0.25):diffusealpha(0.6):decelerate(0.6):rotationz(0):zoom(2):diffusealpha(0)
		end;
	},
	...
	LoadActor(THEME:GetPathG("", "_VisualStyles/"..style.."/Combo 100milestone minisplode"))..{
		InitCommand=function(self) self:diffusealpha(0):blend('add') end;
		HundredMilestoneCommand=function(self)
			self:finishtweening():diffuse(c):rotationz(10):zoom(0.25):diffusealpha(1):linear(0.4):rotationz(0):zoom(1.8):diffusealpha(0)
		end;
	}
}