...
t[#t+1] = Def.Quad {
	...
	OnCommand=function(self)
		self:halign(0):x(-_screen.cx/1.1775):zoomto(_screen.w*WideScale(0.18,0.15),_screen.h*0.0625) 
		self:diffuse(Color.Black):diffusealpha(BrighterOptionRows() and 0.8 or 0.25)
	end;
}
