...
af[#af+1] = Def.ActorFrame{
	...
	Def.BitmapText{
		...
		SwitchFocusToSingleSongMessageCommand=function(self) self:diffuse(Color.White) end;
		SwitchFocusToSongsMessageCommand=function(self) self:diffuse(Color.White) end;
	},
